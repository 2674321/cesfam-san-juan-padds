...
var PAC_SECCIONES = [
  ...
  { nombre: 'RECETAS CONTROLADAS',        ini: 112,fin: 113,bg: '#4A148C', fg: '#ffffff' },
]
...
var PAC_VALIDACIONES = {
  ...
  113: ['V. RECETA', 'POR VENCER', 'VENCIDO', 'PENDIENTE', 'N/A'],
}
...
_RELEVANT_COLS[9] = true  // F. NACIMIENTO (col 9) → recalcula EDAD automáticamente
...
var _COLUMNAS = (function() {
  ...
  // ── RECETAS CONTROLADAS (112-113) ──
  s(112, 'F. RECETA',          'Fecha de la última receta controlada (narcóticos/psicotrópicos)', '', 'Control: col 112 → 113')
  s(113, 'V. RECETA',          'Vigencia de la receta controlada', 'V. RECETA · POR VENCER · VENCIDO · PENDIENTE · N/A', 'Automático')
